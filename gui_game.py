...
def checker(rand_num=randrange(1, 26)):
    ...
    if 3 <= index < 5:
        if rand_num - 5 < 0:
            print(f'რიცხვი მდებარეობს {rand_num+randrange(3,6)}-სა'
                  f' და 0-ს შორის')
        else:
            print(f'რიცხვი მდებარეობს {rand_num+randrange(3,6)}-სა'
                  f' და {rand_num-randrange(3,6)}-ს შორის')
    elif index >= 5:
        if rand_num - 3 < 0:
            print(f'რიცხვი მდებარეობს {rand_num+randrange(2,4)}-სა'
                  f' და 0-ს შორის')
        else:
            print(f'რიცხვი მდებარეობს {rand_num+randrange(2,4)}-სა'
                  f' და {rand_num-randrange(2,4)}-ს შორის')
...
Label(root, text='შეიყვანეთ რიცხვი 1-25 შუალედში', height=2, width=40)\
    .grid(row=0)
